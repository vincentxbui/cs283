...
int add_student(int fd, int id, char *fname, char *lname, int gpa)
{
    ...
    memset(&student_data, 0, STUDENT_RECORD_SIZE);
    ...
    new_student_data.gpa = gpa;
    strncpy(new_student_data.fname, fname, sizeof(new_student_data.fname) - 1);
    new_student_data.fname[sizeof(new_student_data.fname) - 1] = '\0';
    strncpy(new_student_data.lname, lname, sizeof(new_student_data.lname) - 1);
    new_student_data.lname[sizeof(new_student_data.lname) - 1] = '\0';
    ...
    if (write(fd, &new_student_data, STUDENT_RECORD_SIZE) != STUDENT_RECORD_SIZE) {
...
int count_db_records(int fd)
{
    ...
    if (count_of_records == 0) {
        ...
        printf(M_DB_RECORD_CNT, count_of_records);
    }
